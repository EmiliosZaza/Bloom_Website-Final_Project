...
def about(request):
    ...
    volunteers = [
        ...
        {
            'image':    'assets/volunteer-james.png',
            'initials': 'JK',
        ...
        {
            'image':    'assets/volunteer-nina.png',
            'initials': 'NC',
        ...
        {
            'image':    'assets/volunteer-maria.png',
            'initials': 'MA',
            'role':     'Volunteer Coordinator · Crete',
            'name':     'Maria A.',
            'quote':    'Organising planting days is my way of giving back. Watching a team of strangers become a community is magical.',
            'trees':    630,
            'years':    3,
        },
        {
            'image':    'assets/volunteer-tom.png',
            'initials': 'TL',
            'role':     'Trainer · Chios',
            'name':     'Tom L.',
            'quote':    'Training new volunteers is the most rewarding thing I\'ve done. You see someone arrive nervous and leave with fire in their eyes.',
            'trees':    510,
            'years':    2,
        },
    ]
